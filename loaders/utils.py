...
def parse() -> argparse.Namespace:
    ...
    parser.add_argument("--hf_token", type=str, default="", help= "HuggingFace API token file path.")
    parser.add_argument("--push_to_hub", type=str2bool, default=False, help="Whether to push dataset to HF hub.")
    parser.add_argument("--use_all_sources", type=str2bool, default=True, help="Wether to use all sources in config.")
    parser.add_argument("--source", type=str, default="", help="Name of the source to use (if not using all sources).")
    parser.add_argument("--make_commercial_version", type=str2bool, default=True, help="Whether to filter out non-commercial use datasets.")
